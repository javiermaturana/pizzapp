    ...
    <div class="container">
        ...
        <div class="timeline-bubbles">
            ...
            <div class="bubble bubble-3">
                <div class="bubble-content">
                    <a href="https://photos.app.goo.gl/rbexK7mXk8ay52nz6" target="_blank">
                        <h3>Experiencia Plus</h3>
                        <p>Para compartir tus fotos y/o vídeos más divertidos de la noche</p></a>
                </div>
            </div>
        </div>
    </div>
...
<section class="pizzas-section py-5" style="background-color: #fffaf0;" id="participantes">
    <div class="container">
